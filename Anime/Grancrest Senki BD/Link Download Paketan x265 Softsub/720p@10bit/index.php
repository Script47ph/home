...
<html>
    ...
    <head>
        ...
        <title>Link Download 720p@10bit x265 Softsub ~ Pustaka Anime</title>
    ...
    <body>
        ...
        Link Download 720p@10bit x265 Softsub ~ <button type="button" class="close" data-dismiss="alert" aria-label="Close">
