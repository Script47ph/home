...
<html>
    ...
    <head>
        ...
        <title>Pilih Jenis Resolusi ~ Pustaka Anime</title>
    ...
    <body>
        ...
        Pilih jenis resolusi yang kamu inginkan ~ <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">×</span>
            ...
            <div id="directory-list-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-10">Jenis Resolusi</div>
                            ...
                            <div class="row">
                                <span class="file-name col-md-1 col-sm-6 col-xs-9 text-center">
                                    <td class="text-left text-success">
                                        <div style="color: #337ab7; font-size: 13px; font-weight: bold; background-color: transparent; width: 80px; height: 18px; display: inline-block; vertical-align: middle; text-align: center; padding: 0 3px; border-radius: 10px;border: 1px #337ab7 solid;" title="Resolusi">Resolusi</div>
                                    </td>
