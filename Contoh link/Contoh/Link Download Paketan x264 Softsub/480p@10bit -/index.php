...
<html>
    ...
    <head>
        ...
        <title>Link Download 480p@10bit x264 Softsub ~ Pustaka Anime</title>
    ...
    <body>
        ...
        Link Download 480p@10bit x264 Softsub ~ <button type="button" class="close" data-dismiss="alert" aria-label="Close">
