...
<html>
    ...
    <head>
        ...
        <title>Link Download 1080p@10bit x265 Softsub ~ Pustaka Anime</title>
    ...
    <body>
        ...
        Link Download 1080p@10bit x265 Softsub ~ <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">×</span>
            ...
            <ul id="directory-listing" class="nav nav-pills nav-stacked">
                    ...
                    <li data-name="Gdrive" data-href="Gdrive">
                        <a href="Gdrive" class="clearfix" data-name="Gdrive">


                            <div class="row">
                                <span class="file-name col-md-1 col-sm-6 col-xs-9 text-center" style="display: none;">
                                    <i class="fa fa-folder fa-fw" style="display: none;"></i>
    
                                </span>
                                <img src="https://drive.google.com/favicon.ico" style="max-height: 16px;margin-right: 5px;" onerror="imgError(this);">
                    ...
                    <li data-name="Gdrive2" data-href="Gdrive2">
                        <a href="Gdrive2" class="clearfix" data-name="Gdrive2">
                            ...
                            <div class="row">
                                ...
                                <img src="https://sharer.pw/favicon.png" style="max-height: 16px;margin-right: 5px;" onerror="imgError(this);">
                                <span class="file-name col-md-6 col-sm-6 col-xs-9">
                    ...
                    <li data-name="Racaty" data-href="Racaty">
                        <a href="Racaty" class="clearfix" data-name="Racaty">
                            ...
                            <div class="row">
                                ...
                                <img src="https://racaty.com/favicon.ico" style="max-height: 16px;margin-right: 5px;" onerror="imgError(this);">
                                <span class="file-name col-md-6 col-sm-6 col-xs-9">
                    ...
                    <li data-name="Mega" data-href="Mega">
                        <a href="Mega" class="clearfix" data-name="Mega">
                            ...
                            <div class="row">
                                ...
                                <img src="https://mega.nz/favicon.ico" style="max-height: 16px;margin-right: 5px;" onerror="imgError(this);">
                                <span class="file-name col-md-6 col-sm-6 col-xs-9">
                    ...
                    <li data-name="Upload" data-href="Upload">
                        <a href="Upload" class="clearfix" data-name="Upload">
                            ...
                            <div class="row">
                                ...
                                <img src="https://upload.ac/favicon.ico" style="max-height: 16px;margin-right: 5px;" onerror="imgError(this);">
                                <span class="file-name col-md-6 col-sm-6 col-xs-9">
