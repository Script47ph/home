...
<html>
    ...
    <head>
        ...
        <title>Daftar Anime #2 ~ Pustaka Anime</title>
    ...
    <body>
        ...
        Kamu sedang berada di pilihan Daftar Anime #2 ~ <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <div class="row">
                                <span class="file-name col-md-1 col-sm-6 col-xs-9 text-center">
                                    <td class="text-left text-success">
                                        <div style="color: #237ab7; font-size: 13px; font-weight: bold; background-color: transparent; width: 80px; height: 18px; display: inline-block; vertical-align: middle; text-align: center; padding: 0 3px; border-radius: 10px 0px 0px 10px;border: 1px #237ab7 solid;border-right: none;" title="Subtitle Indonesia">Subtitle</div><img style="display: inline-block; vertical-align: middle; border-radius: 0px 10px 10px 0px; height: 18px;border: 1px #237ab7 solid;border-left: none;" src="https://lipis.github.io/flag-icon-css/flags/4x3/id.svg" title="Subtitle Indonesia">
                                    </td>
